...
def newAccount():
    ...
    try:
        driver.get('https://projekt-pg.vxm.pl/prestashop/logowanie?create_account=1')
...
def addProduct():
    ...
    try:
        driver.get('https://projekt-pg.vxm.pl/prestashop/39-industrialne')
        time.sleep(1)
        ...
        driver.get('https://projekt-pg.vxm.pl/prestashop/45-szklane')
        time.sleep(1)
...
def deleteProd():
    ...
    try:
        driver.get('https://projekt-pg.vxm.pl/prestashop/koszyk?action=show')
        time.sleep(1)
...
def submitOrder():
    ...
    try:
        ...
        #input promo code
        inputElement = driver.find_element_by_class_name("promo-input")
