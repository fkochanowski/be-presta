...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'projek28_baza', 'user' => 'projek28_user', 'password' => 'rootpassword', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_337c0ada0dbe2b15ea848e9dfaf53e437c37b70f6feef48faa06fc450fdb6755');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/var/cache/prod//localization'))) && false ?: '_'});
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/app',
            'kernel.project_dir' => '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/var/cache/prod/',
            ...
            'ps_cache_dir' => '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/home/projek28/domains/projekt-pg.vxm.pl/public_html/prestashop/var/cache/prod//doctrine/orm/Proxies',
